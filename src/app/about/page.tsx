      ...
      <div className="grid gap-[30px] w-[930px] h-[630px]" style={{gridTemplateColumns: "100px 385px 385px", gridTemplateRows: "100px 235px 235px"}}>
        ...
        <div
          ...
          >
            ...
            <div className={`group bg-[#F0F0F0] rounded-[50px] row-span-2 shadow-[inset_16px_16px_16px_0_rgba(160,160,160,0.6),inset_-16px_-16px_16px_0_rgba(255,255,255,1)]`}>
            ...
            <ul className="space-y-[8px]">
              <li className="flex items-start gap-x-[20px]">
                ...
                <p className="text-[24px] leading-[1] [text-shadow:3px_3px_3px_rgba(160,160,160,0.6),-3px_-3px_3px_rgba(255,255,255,1)] tracking-[-0.1rem]">
              ...
              <li className="flex items-start gap-x-[20px]">
                ...
                <p className="text-[24px] leading-[1] [text-shadow:3px_3px_3px_rgba(160,160,160,0.6),-3px_-3px_3px_rgba(255,255,255,1)] tracking-[-0.1rem]">
                  finally going full-stack: db, auth, file storage (first client projects)
                </p>
              </li>
              <li className="flex items-start gap-x-[20px]">
