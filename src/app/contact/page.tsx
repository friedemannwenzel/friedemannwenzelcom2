...
export default function Home() {
  ...
  return (
    <div className="flex justify-center items-center h-screen">
      <div className="grid gap-[30px] w-[930px] h-[630px]" style={{gridTemplateColumns: "100px 300px", gridTemplateRows: "100px 235px 235px"}}>
          ...
          >
            <div className="flex flex-col items-center justify-center h-full">
              <div className="grid items-center gap-x-[30px] gap-y-[30px]" style={{gridTemplateColumns: "355px 355px", gridTemplateRows: "75px 75px"}}>
                ...
                <Link href="https://x.com/iamfriedemann" className="group flex flex-col items-center justify-center p-4 rounded-[50px] transition-shadow duration-300 [--og:0] [--ow:0] [--i:1] hover:[--og:0.3] hover:[--ow:1] hover:[--i:0] shadow-[8px_8px_16px_0_rgba(160,160,160,var(--og)),-8px_-8px_16px_0_rgba(255,255,255,var(--ow)),inset_0px_0px_0px_0_rgba(160,160,160,var(--i)),inset_0px_0px_0px_0_rgba(255,255,255,var(--i))]" target="_blank" rel="noopener noreferrer">
                  <p className="text-[32px] font-medium text-center transition-transform duration-300 [text-shadow:3px_3px_3px_rgba(160,160,160,0.6),-3px_-3px_3px_rgba(255,255,255,1)] tracking-[-0.14rem] group-hover:-translate-y-0.5">iamfriedemann</p>
                </Link>
              <div className="shadow-[8px_8px_16px_0_rgba(160,160,160,0.3),-8px_-8px_16px_0_rgba(255,255,255,1)] rounded-[50px] flex items-center justify-center p-4 bg-[#F0F0F0]">
              ...
              <Link href="https://farcaster.xyz/friedemann.eth" className="group flex flex-col items-center justify-center bg-[#F0F0F0] p-4 rounded-[50px] transition-shadow duration-300 [--og:0] [--ow:0] [--i:1] hover:[--og:0.3] hover:[--ow:1] hover:[--i:0] shadow-[8px_8px_16px_0_rgba(160,160,160,var(--og)),-8px_-8px_16px_0_rgba(255,255,255,var(--ow)),inset_0px_0px_0px_0_rgba(160,160,160,var(--i)),inset_0px_0px_0px_0_rgba(255,255,255,var(--i))]" target="_blank" rel="noopener noreferrer">
                <p className="text-[32px] font-medium text-center transition-transform duration-300 [text-shadow:3px_3px_3px_rgba(160,160,160,0.6),-3px_-3px_3px_rgba(255,255,255,1)] tracking-[-0.14rem] group-hover:-translate-y-0.5">friedemann.eth</p>
              </Link>
              </div>
            </div>
          </div>
